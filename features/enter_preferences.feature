...
Scenario: User submits without filling out all of the preferencesWhen I access the time ranking page for project "CS169 Sections" from email "empoleon@berkeley.edu" and secret_id "empoleonsecretid"
    Then I should see "Please enter your preferences for these times."
    When I choose "Cannot go" for time "Dec 1 2019 10:00 AM"
    And I press "Submit"
